...
const aggregatePackageByDayRecv = (pacs: any[]): { [key: string]: number } =>
    pacs
        .reduce((acc: any, curr: any) => {
            if (curr.arrived_date !== undefined) {
                        ...
                        (
                            <>
                                ...
                                <Typography variant="h6" gutterBottom>
                                    {`Thống kê hàng gửi tại ${curPoint} ${month !== 0 ? month.toString() + '/' + year.toString() : year.toString()}`}
                                </Typography>
                                ...
                                <Typography variant="h6" gutterBottom>
                                    {`Thống kê hàng nhận tại ${curPoint} ${month !== 0 ? month.toString() + '/' + year.toString() : year.toString()}`}
                                </Typography>
                                <div style={{ width: '100%', height: 300 }}>
                                    <ResponsiveContainer>
