...
const PackageStatistic = (smallestYear: any) => {
    ...
    const { data: curPackageSend, isLoading: isLoading1 } = useGetList('delivery',
        {
            filter: filter1,
            pagination: {
                page: 1,
    ...
    const { data: curPackageReceive, isLoading: isLoading } = useGetList('delivery',
        {
            filter: filter,
            pagination: {
                page: 1,
                        ...
                        (
                            <>
                                ...
                                <Typography variant="h6" gutterBottom>
                                    {`Thống kê hàng đi tại ${curPoint} ${month !== 0 ? month.toString() + '/' + year.toString() : year.toString()}`}
                                </Typography>
                                ...
                                <Typography variant="h6" gutterBottom>
                                    {`Thống kê hàng đến tại ${curPoint} ${month !== 0 ? month.toString() + '/' + year.toString() : year.toString()}`}
                                </Typography>
                                <div style={{ width: '100%', height: 300 }}>
                                    <ResponsiveContainer>
